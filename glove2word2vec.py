...
# Minorly modified by Jingchen LI <skywalker.ljc@gmail.com>
...
def glove2word2vec(glove_vector_file, output_model_file, demo = False):
    """Convert GloVe vectors into word2vec C format"""
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 4:
        print("Command has 3rd agrgument, demo is set to True.")
        demo = True
    else:
        demo = False
    
    glove2word2vec(glove_vector_file, output_model_file, demo)
